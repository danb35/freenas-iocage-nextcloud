...
* NEXTCLOUD_VERSION: You can set this to an earlier or later Nextcloud major release if desired, but be aware that this script is only tested with the default version.  Currently defaults to 20.
...
### DNS Providers
At this writing (26 October 2020), Caddy v2 supports five DNS authentication plugins:
